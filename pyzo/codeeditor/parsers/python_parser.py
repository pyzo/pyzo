import re
from . import RegexParser, BlockState
...
class MultilineFStringToken(MultilineFStringToken):
...
class PythonLexer(Lexer):
    ...
    states = {
        ...
        "expression": [
            ...
            # Keywords
            from_list(
                [kw for kw in keyword.kwlist if not kw[0].isupper()],
                Keyword,
                suffix=r"\b",
            ),
            ...
            # Type hints
            (r'(->)([ \t]*)(.+?)([ \t]*)(:)', bygroups(Punctuation, Whitespace, TypeHint, Punctuation)),
